...
def destroy(url_name, vm_name):
    """ destroy VM. """

    logging.debug("destroy VM %s" % vm_name)
    conn = cli.getConnection(url_name)
    vm_hndl = conn.lookupByName(vm_name)
...
### Let's do it!
def clone(url_name, orig_name, new_name):
    """ Clone KVM system. """
