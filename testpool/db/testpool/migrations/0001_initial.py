    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.ForeignKey(to='testpool.Key')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('hv', models.ForeignKey(to='testpool.HV')),
            ],
        ),
        migrations.CreateModel(
            name='ProfileKVP',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('kvp', models.ForeignKey(to='testpool.KVP')),
                ('profile', models.ForeignKey(to='testpool.Profile')),
            ],
        ),
        migrations.CreateModel(
            name='VM',
            fields=[
                ...
                ('profile', models.ForeignKey(default=None, blank=True, to='testpool.Profile', null=True)),
            ],
        ),
        migrations.AddField(
            model_name='profile',
            name='kvps',
            field=models.ManyToManyField(to='testpool.KVP', through='testpool.ProfileKVP'),
        ),
    ]
